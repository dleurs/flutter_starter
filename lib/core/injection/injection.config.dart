...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.FruitApi>(() =>
        _i4.FruitApi.create(gh<_i3.Dio>(instanceName: 'public-http-client')));
    gh.factory<_i5.FruitRepository>(
        () => _i6.FruitRepositoryImpl(gh<_i4.FruitApi>()));
    gh.factory<_i7.GetFruitUseCase>(
        () => _i7.GetFruitUseCase(gh<_i5.FruitRepository>()));
    gh.factory<_i8.FruitCubit>(
        () => _i8.FruitCubit(getFruitUseCase: gh<_i7.GetFruitUseCase>()));
    return this;
  }
}
